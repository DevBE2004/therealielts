...
import LearningMethodEditor from "@/components/admin/about/phuong-phap-LCLT/LearningMethodEditor";
import HeroSectionEditor from "@/components/admin/about/phuong-phap-LCLT/HeroSectionEditor";

export default function AdminLearningMethod() {
  ...
  return (
    <div className="p-6 space-y-10">
      <h1 className="text-2xl font-bold text-gray-800 mb-4">
        🧩 Cập nhật nội dung - Phương Pháp LCLT
      </h1>
