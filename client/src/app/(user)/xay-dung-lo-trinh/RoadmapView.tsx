...
import PersonalRoadmapNew from "./PersonalRoadmap";
export const dynamic = "force-dynamic";

export interface IRoadmapUIData {
  section1: {
    title: string;
    subtitle1: string;
    subtitle2: string;
...
export default function RoadmapView({ dataBanner, dataCourse }: Props) {
    ...
    <div id="main" className="flex flex-col min-h-screen">
      ...
      <section id="xay-dung-lo-trinh-ca-nhan-hoa" className="w-full">
        <div className="w-full">
          ...
          <PersonalRoadmapNew courses={dataCourse} />
        </div>
      </section>
