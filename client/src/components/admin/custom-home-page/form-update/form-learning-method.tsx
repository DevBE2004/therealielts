...
export default function FormLearningMethod() {
  const { register, setValue, watch } = useFormContext<BlockLearningMethod>();
  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="grid bg-gray-50/90 p-3 shadow-md rounded-xl gap-2">
        ...
        <div className="grid gap-2">
          <Label>Tiêu đề xuống dòng in đậm</Label>
          <Input {...register("mainTitle")} placeholder="Nhập tiêu đề" />
        </div>
        <div className="grid gap-2">
          <Label>Tiêu đề phụ</Label>
          <Input {...register("subTitle")} placeholder="Nhập tiêu đề" />
        </div>
